...
onemillion could always use more documentation, whether as part of the
official onemillion docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
2. Clone your fork locally::
    ...
    $ git clone git@github.com:your_name_here/onemillion.git
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/fhightower/onemillion/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_onemillion
